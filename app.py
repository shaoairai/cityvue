...
CAMDEFAULT = os.getenv('CAMDEFAULT') # 預設攝影機用
# 圖資
MAP = os.getenv('MAP')
...
def main():
    ...
    return render_template("index.html",APISERVERWEB=APISERVERWEB,FRIGATEIP=FRIGATEIP,FRIGATEIPWEB=FRIGATEIPWEB,MAP=MAP,CAMDEFAULT=CAMDEFAULT,METABASEWEB=METABASEWEB)
